...
public class Nivel3_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Generar números aleatorios para nivel 3 (100-999)
    ...
    private void generarNumerosAleatorios() {
        ...
        numero1 = random.nextInt(900) + 100; // 100-999
        numero2 = random.nextInt(900) + 100; // 100-999
    ...
    private void mostrarResultado(boolean esCorrecto) {
        if (esCorrecto) {
            // Cambiar a layout final de éxito
            setContentView(R.layout.level_success_final);

            TextView textoResultado = findViewById(R.id.textViewExito);
            textoResultado.setText("¡Felicidades!\nCompletaste todos los niveles\n\n" +
                    numero1 + " + " + numero2 + " = " + respuestaCorrecta);

            Button botonJugarOtraVez = findViewById(R.id.botonJugarOtraVez);
            Button botonInicio = findViewById(R.id.botonInicio);

            botonJugarOtraVez.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    // Volver al nivel 1
                    Intent intent = new Intent(Nivel3_Activity.this, Nivel1_Activity.class);
            ...
            botonInicio.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // Volver al inicio
                    Intent intent = new Intent(Nivel3_Activity.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                }
            });
