...
public class Nivel2_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Generar números aleatorios para nivel 2 (10-99)
    ...
    private void irSiguienteNivel() {
        Intent intent = new Intent(this, Nivel3_Activity.class);
